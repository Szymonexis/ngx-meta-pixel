import { NGX_META_PIXEL_CONFIG, NgxMetaPixelConfiguration } from "./ngx-meta-pixel.models";
import {
 ...
 */
export function provideNgxMetaPixel(config: NgxMetaPixelConfiguration): EnvironmentProviders {
